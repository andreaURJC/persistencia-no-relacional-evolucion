...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Vuelo vuelo1 = new Vuelo("Iberia", avionJumbo, aeropuertoAlicante, aeropuertoLeon, null, 2, Arrays.asList(tripulante1, tripulante2));
        Vuelo vuelo2 = new Vuelo("Ryanair", avionAirbus, aeropuertoLeon, aeropuertoAlicante, null, 2, Arrays.asList(tripulante1));
